...
const Planet = props => {
  return(<div className="card">
    ...
    <ul>
      ...
      <li><strong>Moons: </strong> {props.moons}</li></ul>
  </div>)
}
const Container = (props) => {
  return(<div className="container">
    {props.planets.map(elem=><Planet name={elem.name} desc={elem.desc} url={elem.url} diameter={elem.diameter} moons={elem.moons} key={elem.id}/>)}
  </div>)
}
...
ReactDOM.render(<Container planets={planets}/>, document.getElementById('root'))
